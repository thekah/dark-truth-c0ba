...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/dark-truth-c0ba)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/dark-truth-c0ba
```

A live public deployment of this template is available at [https://dark-truth-c0ba.templates.workers.dev](https://dark-truth-c0ba.templates.workers.dev)
